...
const Header = () => {
    ...
    return (
        <header className=" fixed-div cd-font-sans cd-header cd-flex cd-items-center cd-justify-between cd-p-4 cd-shadow-md dark:cd-bg-zinc-00" >
            <a href="" className="cd-text-3xl cd-font-bold cd-text-black cd-m-3">Wallet
                <span className="cd-text-violet-700">fy</span>
            </a>
            <button 
            className="cd-p-3 cd-rounded-md cd-shadow-lg cd-bg-gray-200 cd-mx-6 "
